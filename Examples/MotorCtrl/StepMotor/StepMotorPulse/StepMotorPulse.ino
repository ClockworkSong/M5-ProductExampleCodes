...
void loop() {
  ...
  if (digitalRead(39) == LOW)  // A button
  {
    ...
    SendCommand(STEPMOTOR_I2C_ADDR, "G1 X20Y20Z20 F300");
    SendCommand(STEPMOTOR_I2C_ADDR, "G1 X0Y0Z0 F300");
  }
  if (digitalRead(37) == LOW)  // C button
  {
    while (1) {
      SendCommand(STEPMOTOR_I2C_ADDR, "G1 X0Y0Z0 F200");
      delay(1000);
      M5.Lcd.print(".");
      delay(1000);
      SendCommand(STEPMOTOR_I2C_ADDR, "G1 X5Y5Z5 F200");
      delay(1000);
      M5.Lcd.print(".");
      delay(1000);
    }
